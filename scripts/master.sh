...
while test $# -gt 0; do
        case "$1" in
                -h|--help)
                        ...
                        echo "-m, --master-ip=IP       specify the kubernetes master ip"
                        echo "-k, --k8s-version=K8S_VERSION      specify the k8s version to use"
                        exit 0
                        ;;
                -m)
                        shift
                        ...
                        ;;
                --master-ip*)
                        export MASTER_IP=`echo $1 | sed -e 's/^[^=]*=//g'`
                        shift
                        ;;
                -k)
                        shift
                        ...
                        ;;
                --k8s-version*)
                        export K8S_VERSION=`echo $1 | sed -e 's/^[^=]*=//g'`
                        shift
                        ;;
                *)
                        break
